          ...
          <div className="prose prose-lg text-gray-700 space-y-6">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Provide the Service:</strong> Manage poker games,
                  track results, and facilitate group communication
                </li>
                <li>
                  <strong>Send Notifications:</strong> Deliver game invitations,
                  results, and updates via SMS and email when you opt-in
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                When you join a poker group, certain information is shared with
                other group members, including: your name, game participation,
                and results. This is essential for the functionality of the
                Service.
              </p>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>AWS:</strong> Cloud hosting and database services
                </li>
                <li>
                  <strong>Twilio:</strong> SMS message delivery
                </li>
                <li>
                  <strong>Email Service Providers:</strong> Email notification
                  delivery
                </li>
              </ul>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  Sell your personal information to advertisers or third parties
                </li>
                <li>
                  Share your contact information outside your poker groups
                  without consent
                </li>
                <li>
                  Use your information for advertising or marketing unrelated to
                  the Service
                </li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">
                4. SMS and Communication Privacy
              </h2>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  We use your phone number solely to send game-related messages
                </li>
              ...
              <p>
                Email notifications are sent through secure email services and
                include:
              </p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Secure Infrastructure:</strong> Hosted on AWS with
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Opt-Out:</strong> Disable SMS and email notifications
                  at any time
                </li>
                <li>
              ...
              <p>
                To exercise these rights, contact us through the Service or your
                account settings.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Changing 500 is not intended for users under 18 years of age. We
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  Sending you an email notification (if you've provided an email
                  address)
                </li>
            ...
            <section>
              ...
              <p>
                ...
                practices, please contact us through the Service or visit our
                support page.
              </p>
            </section>
          </div>
