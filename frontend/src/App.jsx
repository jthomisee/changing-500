...
const Changing500App = () => {
  return (
    <AuthProvider>
      <Router>
        <Routes>
          <Route path="/" element={<Changing500 />} />
          <Route path="/rsvp" element={<RSVPPage />} />
          <Route path="/rsvp/:gameId/:userId" element={<RSVPPage />} />
          <Route path="/rsvp-token/:token" element={<TokenRSVPPage />} />
          <Route path="/profile" element={<Changing500 activeView="profile" />} />
          <Route path="/admin/users" element={<Changing500 activeView="users" />} />
          <Route path="/groups" element={<Changing500 activeView="groups" />} />
...
const Changing500 = ({ activeView: propActiveView }) => {
  ...
  const upcomingGames = (selectedGroup ? scheduledGames.filter(g => g.groupId === selectedGroup.groupId) : scheduledGames)
  ...
  const handleSaveGame = async (e) => {
    ...
    try {
      ...
      const { date: utcDate, time: utcTime } = convertToUTC(newGame.date, newGame.time, userTimezone);
